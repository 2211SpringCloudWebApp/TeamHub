	...
	<body>
		<div id="sideBar">
	           <ul>
	               ...
	               <li><a href="/user/list"><img class="side-icon" src="../../../resources/img/sidebar/user.png"><span>사원관리</span></a></li>
	               <li><a href="/project/list"><img class="side-icon" src="../../../resources/img/sidebar/project(2).png"><span>프로젝트</span></a></li>
	               <li><a href="/approval/draftDocuments"><img class="side-icon" src="../../../resources/img/sidebar/approval.png"><span>전자결재</span></a></li>
	               <li><a href="/free/list"><img class="side-icon" src="../../../resources/img/sidebar/free.png"><span>게시판</span></a></li>
	           </ul>
	    </div>
	</body>
</html>