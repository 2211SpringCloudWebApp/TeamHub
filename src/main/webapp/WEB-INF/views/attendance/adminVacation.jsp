				...
				<div id="main-container">
                    ...
                    <div id="list">
                        <table id="list-table" class="table">
                            ...
                            <tbody>
                            	<c:forEach items="${vuList }" var="vacation" varStatus="i">
                            		<tr>
                              ...
                              <tr align="center">
                                  <td colspan="5">
                                      <c:if test="${pi.currentPage > 1 }">
										<a href="/attendance/adminVacation?status=${status }&page=1"> &#10094;&#10094; </a>&nbsp;&nbsp;
									</c:if>
									<c:if test="${pi.currentPage > 1 }">
										<a href="/attendance/adminVacation?status=${status }&page=${pi.currentPage -1 }"> &#10094; </a>
									</c:if>
									&nbsp;&nbsp;&nbsp;
									<c:forEach begin="${pi.startNavi }" end="${pi.endNavi }" var="page">
										<c:url var="pageUrl" value="/attendance/adminVacation">
									...
									<c:if test="${pi.currentPage < pi.maxPage }">
										<a href="/attendance/adminVacation?status=${status }&page=${pi.maxPage }"> &#10095;&#10095; </a>
									</c:if>
                                  </td>
                              </tr>
                            </tfoot>
